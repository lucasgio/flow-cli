...
class HotReloadUseCase {
  ...
  Future<String?> captureScreenshot(DeviceModel device) async {
    try {
      ...
      final screenshotPath = path.join(
        screenshotDir.path,
        'screenshot_${device.platform}_$timestamp.png'
      );
  ...
  Future<String?> _captureAndroidScreenshot(DeviceModel device, String outputPath) async {
    try {
  ...
  Future<String?> _captureIOSScreenshot(DeviceModel device, String outputPath) async {
    try {
  ...
  Future<Map<String, dynamic>> getPerformanceMetrics(HotReloadSession session) async {
    try {
