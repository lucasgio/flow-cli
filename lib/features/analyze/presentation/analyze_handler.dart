...
class AnalyzeHandler {
  ...
  Future<void> handle(List<String> args) async {
    final parser = ArgParser()
      ..addFlag('optimize',
          help: 'Show optimization recommendations', negatable: false)
      ..addFlag('performance',
          help: 'Analyze performance issues', negatable: false)
      ...
      ..addFlag('help',
          abbr: 'h', help: 'Show help for analyze command', negatable: false);
    ...
    try {
      ...
      if (runAll || results['optimize']) {
        final optimizationAnalysis =
            await _analyzeUseCase.analyzeOptimizations();
  ...
  void _printSizeResults(Map<String, dynamic> results) {
    ...
    final largeDependencies =
        results['largeDependencies'] as List<String>? ?? [];
