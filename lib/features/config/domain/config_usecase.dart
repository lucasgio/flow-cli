...
class ConfigUseCase {
  ...
  Future<void> createClientStructure(String clientName) async {
    try {
      ...
      final clientDir = Directory(path.join(projectPath, 'assets', 'configs', clientName));
      ...
      await _createPlaceholderFile(
        path.join(clientDir.path, 'icon.png'),
        'App Icon Placeholder',
        'Required dimensions: 1024x1024 pixels'
      );
      
      await _createPlaceholderFile(
        path.join(clientDir.path, 'splash.png'),
        'Splash Screen Placeholder',
        'Required dimensions: 1242x2436 pixels'
      );
  ...
  Future<void> _createPlaceholderFile(String filePath, String title, String description) async {
...
''');
  ...
  Future<void> updateClientConfig(String clientName, Map<String, dynamic> config) async {
    try {
      final projectPath = _configService.projectPath;
      if (projectPath == null) {
