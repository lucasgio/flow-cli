...
class LocalizationService {
  ...
  static const Map<String, String> _englishTranslations = {
    // Help
    'help.description': 'A comprehensive Flutter CLI tool for project management, building, and deployment',
    'help.more_info': 'For more information, visit: https://docs.flowstore.com/flow-cli',
  ...
  static const Map<String, String> _spanishTranslations = {
    // Help
    'help.description': 'Una herramienta CLI integral de Flutter para gestión de proyectos, construcción y despliegue',
    'help.more_info': 'Para más información, visita: https://docs.flowstore.com/flow-cli',
    ...
    'commands.hotreload': 'Iniciar sesión de hot reload con logs en tiempo real',
    ...
    'setup.folder_structure': 'Por favor crea la siguiente estructura de carpetas:',
    ...
    'config.flutter_not_found': 'SDK de Flutter no encontrado en la ruta especificada',
